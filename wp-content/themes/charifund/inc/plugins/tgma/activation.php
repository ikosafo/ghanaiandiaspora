 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme charifund for publication on ThemeForest
...
add_action( 'tgmpa_register', 'charifund_register_required_plugins' );
 ...
 */
function charifund_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'         => 'Charifund Core',
            'slug'         => 'charifund-core',
            'source'       => 'https://wowtheme7.com/wp/demo-file/charifund/charifund-core.zip',
            'required'     => true,
            'version'      => '1.0.0',
