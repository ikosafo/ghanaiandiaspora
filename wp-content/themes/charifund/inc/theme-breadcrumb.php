...
class Charifund_Breadcrumb {
	/**
	 * Array of bread Charifund_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct( array $options = [] ) {
		...
		$this->defaults['home'] = esc_html__('Home','charifund');
		$this->defaults['blog'] = esc_html__('Blog','charifund');
	...
	public function theBreadcrumbs() {
		...
		foreach ( $breadcrumbs as $crumb ) {
			...
			if ( $crumb['url'] ) {
                ...
                $html .= sprintf( '<span>%s</span>', wp_kses($crumb['title'],charifund()->kses_allowed_html('all')) );
			}
		...
		echo wp_kses($html,charifund()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs() {
		...
		$breadcrumbs = apply_filters( 'charifund_get_breadcrumbs', $breadcrumbs );
 ...
 * Template Functions.
 */
if ( ! function_exists( 'charifund_breadcrumb' ) ) {
	/**
	 ...
	 * @package charifund
	 */
	function charifund_breadcrumb( $options = [] ) {
		$Crumbs = new Charifund_Breadcrumb( $options );
		$Crumbs->theBreadcrumbs();
	}
}

if ( ! function_exists( 'charifund_get_breadcrumbs' ) ) {
	/**
	 ...
	 * @return array
	 */
	function charifund_get_breadcrumbs( $options = [] ) {
		$Crumbs = new Charifund_Breadcrumb( $options );
 ...
 * Utility functions
 */
if ( ! function_exists( 'charifund_breadcrumb_array_insert' ) ) {
	/**
	 ...
	 * @return array
	 */
	function charifund_breadcrumb_array_insert( array $array, $element, int $position ) {
