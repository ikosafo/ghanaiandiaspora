...
$footer_1_newsletter_enabled = cs_get_option('footer_1_newsletter_enabled');
$footer_1_newsletter_title = cs_get_option('footer_1_newsletter_title');
$footer_1_newsletter_text = cs_get_option('footer_1_newsletter_text');
$footer_1_newsletter_shortcode = cs_get_option( 'footer_1_newsletter_shortcode' );
...
$footer_1_bg_shape_2 = cs_get_option('footer_1_bg_shape_2');
if (isset($footer_1_bg_shape_2['url']) && !empty($footer_1_bg_shape_2['url'])) {
    $background_image_url_2 = esc_url($footer_1_bg_shape_2['url']);
} else {
...
<footer class="footer-two">
    ...
    <div class="container">
        <?php if ($footer_1_newsletter_enabled) : ?>
        <div class="row align-items-center gutter-30">
            <div class="col-12 col-lg-7 col-xxl-6">
                <div class="footer-two__newsletter-content">
                <h3 class="title-animation">
                    <?php echo esc_html($footer_1_newsletter_title); ?>
                </h3>
                <p>
                <?php
                if (!empty($footer_1_newsletter_text)) {
                    echo wp_kses_post($footer_1_newsletter_text);
                }                                
                ?>
                </p>
                </div>
            ...
            <div class="col-12 col-lg-5 col-xxl-5 offset-xxl-1">
                <div class="footer-two__newsletter-form">
                    <?php                  
                    if (!empty($footer_1_newsletter_shortcode)) : ?>
                        <?php echo do_shortcode(esc_html($footer_1_newsletter_shortcode)); ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="row gutter-60">
            <div class="col-12 col-md-6 col-xl-3">
                ...
                <div class="footer-two__widget-content">
                    ...
                    <?php
                    $socials = cs_get_option('footer_1_socials_repeater');
                    if (!empty($socials)) {
                        echo '<div class="social">';
                        foreach ($socials as $social) {
                            $icon = isset($social['footer_1_socials_icon']) ? esc_attr($social['footer_1_socials_icon']) : '';
                            $url = isset($social['footer_1_socials_icon_url']) ? esc_url($social['footer_1_socials_icon_url']) : '#';
            ...
            <div class="col-12 col-md-6 col-xl-3">
                ...
                <div class="footer-two__widget-intro">
                    <h5><?php echo esc_html($footer_1_contact_title); ?></h5>
                    <div class="line">
                ...
                <div class="footer-two__widget-content footer-two__widget-content--contact">
                    <?php
                    $contacts = cs_get_option('footer_1_contacts_repeater');

                    if (!empty($contacts)) {
                        echo '<ul>';
                        foreach ($contacts as $contact) {
                            // Get icon, title, and URL
                            $icon = isset($contact['footer_1_contacts_icon']) ? esc_attr($contact['footer_1_contacts_icon']) : '';
                            $title = isset($contact['footer_1_contacts_title']) ? esc_html($contact['footer_1_contacts_title']) : '';
                            $url = isset($contact['footer_1_contacts_title_url']) ? esc_url($contact['footer_1_contacts_title_url']) : '#';
        ...
        <div class="container">
            <div class="row align-items-center gutter-12">
                ...
                <div class="footer__bottom-left">
                    <?php
                    $terms = cs_get_option('footer_1_terms_repeater');

                    if (!empty($terms)) {
                        echo '<ul class="footer__bottom-list justify-content-center justify-content-lg-end">';
                        foreach ($terms as $term) {
                            // Get title and URL
                            $title = isset($term['footer_1_terms_title']) ? esc_html($term['footer_1_terms_title']) : '';
                            $url = isset($term['footer_1_terms_title_url']) ? esc_url($term['footer_1_terms_title_url']) : '#';
