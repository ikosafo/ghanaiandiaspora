...
$page_layout_meta = Charifund_Group_Fields_Value::page_layout('charifund');
$page_container_meta = Charifund_Group_Fields_Value::page_container('charifund','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area charifund-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
