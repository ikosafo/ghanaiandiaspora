...
class Charifund_Recent_Post_title_Widget extends WP_Widget

{
    public function __construct()
    {
        parent::__construct(
            'charifund_popular_posts_title',
            esc_html__('Charifund: Recent Posts Title', 'charifund-core'),
...
if (!function_exists('Charifund_Recent_Post_title_Widget')) {

    function Charifund_Recent_Post_title_Widget()

    {
        register_widget('Charifund_Recent_Post_title_Widget');
    }

    add_action('widgets_init', 'Charifund_Recent_Post_title_Widget');
