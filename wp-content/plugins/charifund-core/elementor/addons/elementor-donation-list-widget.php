...
class Charifund_Donation_List_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-list-widget';
    }
    ...
    {
        return esc_html__('Donation List', 'charifund-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_List_Widget());