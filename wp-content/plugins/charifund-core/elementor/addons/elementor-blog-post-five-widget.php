...
class Blog_Post_Five extends Widget_Base
{
    ...
    {
        return 'charifund-blog-post-five-widget';
    }
    ...
    {
        return esc_html__('Blog Post 5', 'charifund-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Blog_Post_Five());