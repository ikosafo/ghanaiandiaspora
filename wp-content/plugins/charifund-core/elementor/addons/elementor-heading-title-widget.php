...
class Heading_Title extends Widget_Base {
	...
	public function get_name() {
		return 'charifund-heading-title-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Heading Title', 'charifund-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'show',
				'selectors' => [
					'{{WRAPPER}} .title-animation' => 'display: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle'    => true,
				'selectors' => [
					'{{WRAPPER}} .title-animation' => 'text-align: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .title-animation' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .title-animation' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .title-animation',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .title-animation' => 'color: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .title-animation' => 'background-color: {{VALUE}} !important',
				],
			]
		);
