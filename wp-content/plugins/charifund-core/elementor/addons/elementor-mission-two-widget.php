...
class Mission_Two extends Widget_Base {
	...
	public function get_name() {
		return 'charifund-mission-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Mission Widget 02', 'charifund-core' );
	}
		  	...
		  	'repeat', [
				...
				'default' => 
					...
					'fields' => [						
						...
						[
							'name' => 'block_number',
							'label' => esc_html__('Nuber', 'charifund-core'),
							'type' => Controls_Manager::TEXTAREA,
							'default' => esc_html__('', 'charifund-core'),
						],
	...
	protected function render() {
		...
		<script>
			...
			var testimonial = new Swiper(".ministrie-eight-active-2", {
				loop: true,
				speed: 1000,
				slidesPerView: 1,
				slidesPerGroup: 1,
...
<?php  if ( 'style1' === $settings['style'] ) : ?>	
	<div class="mission-section_two">
		<div class="mission">
			<div class="ministrie-eight-slide">
				<div class="ministrie-eight-active-2 swiper-container swiper">
						...
						<div class="swiper-slide">
							<div class="mission-single">
								<div class="ministrie-eight-wrapper swiper-slide">
									<div class="ministrie-eight-thumb">
										
											<div class="ministrie-top-content">
												<?php if(!empty(wp_get_attachment_url($item['block_image']['id']))): ?>
												<img src="<?php echo wp_get_attachment_url($item['block_image']['id']);?>" alt="">
													<?php endif;?>
												<h3 class="number"><?php echo wp_kses($item['block_number'], $allowed_tags);?></h3>
											</div>

										<div class="ministrie-wrap">
											
											<div class="ministrie-content">
												<h4 class="ministrie-title"><?php echo wp_kses($item['block_title'], $allowed_tags);?></h4>
												<p class="ministrie-paragraph"><?php echo wp_kses($item['block_description'], $allowed_tags);?></p>
											</div>

											<div class="ministrie--button">
...
Plugin::instance()->widgets_manager->register_widget_type(new Mission_Two());