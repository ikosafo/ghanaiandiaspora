...
class Charifund_Donation_Slider_Three_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-slider-three-widget';
    }
    ...
    {
        return esc_html__('Donation Slider 3', 'charifund-core');
    }
    ...
    protected function render()
    {
        ...
        <div class="cause home_13 p-0 bg-transparent">
            <div class="cause__slider-wrapper">
                <div class="cause__slider cause_slider_3 swiper">
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Slider_Three_Widget());