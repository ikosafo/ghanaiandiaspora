...
class Charifund_Donation_Form_Six_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-form-six-widget';
    }
    ...
    {
        return esc_html__('Donation Form 6', 'charifund-core');
    }
                ...
                <div class="community-donation" data-aos="fade-up" data-aos-duration="1000">
                    <div class="community-donation__inner">
                        ...
                        <div class="donation-form">
                            ...
                            <div class="donation-form__single_2">
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Form_Six_Widget());