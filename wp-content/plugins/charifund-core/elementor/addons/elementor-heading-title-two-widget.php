...
class Heading_Title_Two extends Widget_Base {
	...
	public function get_name() {
		return 'charifund-heading-title-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Heading Title 02', 'charifund-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'toggle'    => true,
				'selectors' => [
					'{{WRAPPER}} .heading-two' => 'text-align: {{VALUE}} !important',
				],
			]
		);
...
<div class="section__header heading-two p-0 m-0">
...
Plugin::instance()->widgets_manager->register_widget_type(new Heading_Title_Two());