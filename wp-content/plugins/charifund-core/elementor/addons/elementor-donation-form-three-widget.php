...
class Charifund_Donation_Form_Three_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-form-three-widget';
    }
    ...
    {
        return esc_html__('Donation Form 03', 'charifund-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Form_Three_Widget());