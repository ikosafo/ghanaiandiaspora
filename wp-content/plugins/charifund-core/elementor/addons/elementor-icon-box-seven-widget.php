 ...
 */
namespace Elementor;
class Charifund_Icon_Box_Seven_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-icon-box-seven-widget';
    }
    ...
    {
        return esc_html__('charifund Icon Box 7', 'charifund-core');
    }
	...
	<div class="icon-box-six home-15-7">
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Icon_Box_Seven_Widget());