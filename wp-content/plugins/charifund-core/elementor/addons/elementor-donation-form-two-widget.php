...
class Charifund_Donation_Form_Two_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-form-two-widget';
    }
    ...
    {
        return esc_html__('Donation Form 02', 'charifund-core');
    }
    ...
    protected function render()
    {
        ...
        <div class="community home-9">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-9">
                        <div class="section__header" data-aos="fade-up" data-aos-duration="1000">
                            <?php if($settings['subtitle']) : ?>
                                <h4 class="sub-title"><i class="icon-donation"></i><?php echo $settings['subtitle'];?></h4>
                            <?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Form_Two_Widget());