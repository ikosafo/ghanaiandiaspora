 ...
 */
namespace Elementor;
class Charifund_Icon_Box_Six_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-icon-box-six-widget';
    }
    ...
    {
        return esc_html__('charifund Icon Box Six', 'charifund-core');
    }
	...
	<div class="icon-box-six">
		<div class="goal_single <?php if('yes' === $settings['show_active']){echo esc_attr('goal__single-active');}?>">
			<div class="thumbs">
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Icon_Box_Six_Widget());