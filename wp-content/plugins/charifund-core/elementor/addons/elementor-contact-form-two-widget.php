...
class Contact_Form_Two extends Widget_Base {
	...
	public function get_name() {
		return 'charifund-contact-form-two-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact Form 02', 'charifund-core' );
	}
...
<?php  if ( 'style1' === $settings['style'] ) : ?>	
	...
	<section class="contact home-3-contact-form home-10">
			<div class="row">
				<div class="col-12">
...
Plugin::instance()->widgets_manager->register_widget_type(new Contact_Form_Two());