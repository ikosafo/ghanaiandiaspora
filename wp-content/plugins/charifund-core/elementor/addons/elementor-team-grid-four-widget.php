...
class Team_Grid_Four extends Widget_Base {
	...
	public function get_name() {
		return 'charifund-team-grid-four-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Team Grid 04', 'charifund-core' );
	}
	...
	protected function render() {
		...
		<?php  if ( 'style1' === $settings['style'] ) : ?>	
			<div class="team p-0 m-0">	
				<div class="team_single-wrapper home-9">
					<div class="team_single van-tilt">
...
Plugin::instance()->widgets_manager->register_widget_type(new Team_Grid_Four());