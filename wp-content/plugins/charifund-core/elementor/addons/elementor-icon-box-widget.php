 ...
 */
namespace Elementor;
class Charifund_Icon_Box_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-icon-box-widget';
    }
    ...
    {
        return esc_html__('charifund Icon Box', 'charifund-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Icon_Box_Widget());