...
class Charifund_Donation_Slider_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-slider-widget';
    }
    ...
    {
        return esc_html__('Donation Slider', 'charifund-core');
    }
    ...
    protected function render()
    {
        ...
        <div class="cause p-0 bg-transparent">
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Slider_Widget());