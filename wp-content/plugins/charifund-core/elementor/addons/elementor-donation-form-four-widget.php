...
class Charifund_Donation_Form_Four_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-form-four-widget';
    }
    ...
    {
        return esc_html__('Donation Form 04', 'charifund-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Form_Four_Widget());