...
class Charifund_Donation_Slider_Two_Widget extends Widget_Base
{
    ...
    {
        return 'charifund-donation-slider-two-widget';
    }
    ...
    {
        return esc_html__('Donation Slider 2', 'charifund-core');
    }
    ...
    protected function render()
    {
        ...
        <div class="cause cause-three pt-0">
...
Plugin::instance()->widgets_manager->register_widget_type(new Charifund_Donation_Slider_Two_Widget());