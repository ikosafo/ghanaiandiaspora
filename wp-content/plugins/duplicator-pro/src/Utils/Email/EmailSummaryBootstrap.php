...
class EmailSummaryBootstrap
{
    ...
    public static function init(): void
    {
        ...
        add_action('duplicator_pro_transfer_failed', function (UploadInfo $uploadInfo): void {
        ...
        add_action('duplicator_pro_transfer_cancelled', function (UploadInfo $uploadInfo): void {
            if ($uploadInfo->isDownloadFromRemote()) {
                return;
            }
        ...
        add_action('duplicator_pro_upload_complete', function (UploadInfo $uploadInfo): void {
            if ($uploadInfo->isDownloadFromRemote()) {
                return;
            }
