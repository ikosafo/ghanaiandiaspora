...
?>
	<div class="ithemes-updater-products" id="ithemes-updater-unrecognized">
		<div class="solidwp-table-header">
			<div>
				<h3><?php _e( 'Unrecognized Products', 'it-l10n-backupbuddy' ); ?></h3>
...
<?php
	...
	private function show_notices( $is_staging = false ) {
		if ( $is_staging) {
			echo "<div class=\"updated\"><p><strong>" . __( 'As a staging site, licenses for the products and services listed below do not count toward your license usage.', 'it-l10n-backupbuddy' ) . "</strong></p></div>\n";
		}
